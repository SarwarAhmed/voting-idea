...
class CreateIdeasTest extends TestCase
{
    ...
    /** @test */
    public function create_idea_from_does_not_shwo_when_logged_out()
    {
    ...
    /** @test */
    public function create_idea_from_does_shwo_when_logged_in()
    {
    ...
    /** @test */
    public function main_paige_contains_create_idea_livewire_component()
    {
        $user = User::factory()->create();
