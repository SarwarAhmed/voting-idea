...
<body class="font-sans bg-gray-background text-gray-900 text-sm">
    <header class="flex flex-col md:flex-row items-center justify-between px-8 py-4">
        <a href="#"><img src="{{ asset('images/logo.svg') }}" alt="Laracasts"></a>
    ...
    <main class="container mx-auto max-w-custom flex flex-col md:flex-row">
        <div class="w-70 mx-auto md:mx-0 md:mr-5">
            <div class="bg-white md:sticky md:top-8 border-2 border-blue rounded-xl mt-16" style="border-image-source: linear-gradient(to bottom, rgba(50, 138, 241, 0.22), rgba(99, 123, 255, 0));
                ...
                @auth
                    <form action="" method="" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text"
                ...
                @else
                    <div class="my-6 text-center">
                        <a href="{{ route('login') }}"
                            class="inline-block items-center justify-center w-1/2 h-11 text-white text-xs bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                            <span class="">Login</span>
                        </a>
                        <a href="{{ route('register') }}"
                            class="inline-block mt-4 items-center justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                            Register
                        </a>
                    </div>
                @endauth
        ...
        <div class="w-full px-2 md:px-0 md:w-175">
            <nav class="hidden md:flex items-center justify-between text-xs">
                <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                    ...
                    <li><a href="#"
                            class="text-gray-500 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">Considering
                            (7)</a></li>
                    <li><a href="#"
                            class="text-gray-500 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">In
                            Progress (3)</a></li>
                </ul>

                <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                    <li><a href="#"
                            class="text-gray-500 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">Implemented
                            (7)</a></li>
                    <li><a href="#"
                            class="text-gray-500 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue">Closed
                            (10)</a></li>
                </ul>
            </nav>
